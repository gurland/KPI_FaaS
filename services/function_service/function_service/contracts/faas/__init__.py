...
# sources: api_gateway_trigger_service.proto, auth_service.proto, common.proto, crontab_trigger_service.proto, function_service.proto, load_balancer_service.proto, node_agent_service.proto, runtime_service.proto
...
class AgentServiceStub(betterproto.ServiceStub):
    async def launch_runtime(
        self,
        launch_runtime_request: "LaunchRuntimeRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            "/faas.AgentService/LaunchRuntime",
    ...
    async def invoke_function(
        ...
        *,
        ...
        return await self._unary_unary(
            "/faas.AgentService/InvokeFunction",
            invoke_function_request,
            InvocationResult,
            timeout=timeout,
            deadline=deadline,
...
class AgentServiceBase(ServiceBase):
    ...
    async def launch_runtime(
        self, launch_runtime_request: "LaunchRuntimeRequest"
    ) -> "Empty":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def stop_runtime(self, brief_runtime: "BriefRuntime") -> "Empty":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def __rpc_launch_runtime(
        self, stream: "grpclib.server.Stream[LaunchRuntimeRequest, Empty]"
    ) -> None:
        request = await stream.recv_message()
        response = await self.launch_runtime(request)
        await stream.send_message(response)

    async def __rpc_stop_runtime(
        self, stream: "grpclib.server.Stream[BriefRuntime, Empty]"
    ) -> None:
        request = await stream.recv_message()
        response = await self.stop_runtime(request)
        await stream.send_message(response)
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            "/faas.AgentService/LaunchRuntime": grpclib.const.Handler(
                self.__rpc_launch_runtime,
                grpclib.const.Cardinality.UNARY_UNARY,
                LaunchRuntimeRequest,
                Empty,
            ),
            "/faas.AgentService/StopRuntime": grpclib.const.Handler(
                self.__rpc_stop_runtime,
                grpclib.const.Cardinality.UNARY_UNARY,
                BriefRuntime,
                Empty,
            ),
            "/faas.AgentService/InvokeFunction": grpclib.const.Handler(
                self.__rpc_invoke_function,
                grpclib.const.Cardinality.UNARY_UNARY,
                InvokeFunctionRequest,
                InvocationResult,
